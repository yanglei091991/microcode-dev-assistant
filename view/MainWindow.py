...
class MainWindow(QMainWindow):  
    ...
    def createToolBars(self):
        ...
        self.register1Check = QCheckBox(self.register[1], registerToolBar) 
        self.register1Text = QLineEdit("0", registerToolBar)
        self.register1Text.setFixedSize(40, 20)
        #self.register1Text.setEnabled(False)
        self.register2Check = QCheckBox(self.register[2], registerToolBar) 
        self.register2Text = QLineEdit("0", registerToolBar)
        self.register2Text.setFixedSize(40, 20)
        #self.register2Text.setEnabled(False)
        self.register3Check = QCheckBox(self.register[3], registerToolBar)
        self.register3Text =QLineEdit("0", registerToolBar)
